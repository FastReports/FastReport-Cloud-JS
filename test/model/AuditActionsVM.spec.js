...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AuditActionsVM();
  });
  ...
  describe('AuditActionsVM', function() {
    it('should create an instance of AuditActionsVM', function() {
      // uncomment below and update the code to test AuditActionsVM
      //var instance = new FastreportCloudSdk.AuditActionsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AuditActionsVM);
    });
