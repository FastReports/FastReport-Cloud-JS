...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ReportCreateFormVM();
  });
  ...
  describe('ReportCreateFormVM', function() {
    it('should create an instance of ReportCreateFormVM', function() {
      // uncomment below and update the code to test ReportCreateFormVM
      //var instance = new FastreportCloudSdk.ReportCreateFormVM();
      //expect(instance).to.be.a(FastreportCloudSdk.ReportCreateFormVM);
    });
