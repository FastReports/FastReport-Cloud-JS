...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UpdatePrepareTemplateTaskVM();
  });
  ...
  describe('UpdatePrepareTemplateTaskVM', function() {
    it('should create an instance of UpdatePrepareTemplateTaskVM', function() {
      // uncomment below and update the code to test UpdatePrepareTemplateTaskVM
      //var instane = new FastreportCloudSdk.UpdatePrepareTemplateTaskVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UpdatePrepareTemplateTaskVM);
    });
    ...
    it('should have the property exports (base name: "exports")', function() {
      ...
      //var instance = new FastreportCloudSdk.UpdatePrepareTemplateTaskVM();
