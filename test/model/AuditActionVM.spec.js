...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AuditActionVM();
  });
  ...
  describe('AuditActionVM', function() {
    it('should create an instance of AuditActionVM', function() {
      // uncomment below and update the code to test AuditActionVM
      //var instance = new FastreportCloudSdk.AuditActionVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AuditActionVM);
    });
    ...
    it('should have the property adminAction (base name: "adminAction")', function() {
      // uncomment below and update the code to test the property adminAction
      //var instance = new FastreportCloudSdk.AuditActionVM();
      //expect(instance).to.be();
    });
