...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ExportReportTaskVM();
  });
  ...
  describe('ExportReportTaskVM', function() {
    it('should create an instance of ExportReportTaskVM', function() {
      // uncomment below and update the code to test ExportReportTaskVM
      //var instane = new FastreportCloudSdk.ExportReportTaskVM();
