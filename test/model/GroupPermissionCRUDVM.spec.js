...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.GroupPermissionCRUDVM();
  });
  ...
  describe('GroupPermissionCRUDVM', function() {
    it('should create an instance of GroupPermissionCRUDVM', function() {
      // uncomment below and update the code to test GroupPermissionCRUDVM
      //var instance = new FastreportCloudSdk.GroupPermissionCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.GroupPermissionCRUDVM);
    });
