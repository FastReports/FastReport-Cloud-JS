...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AuditSubscriptionActionVM();
  });
  ...
  describe('AuditSubscriptionActionVM', function() {
    it('should create an instance of AuditSubscriptionActionVM', function() {
      // uncomment below and update the code to test AuditSubscriptionActionVM
      //var instance = new FastreportCloudSdk.AuditSubscriptionActionVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AuditSubscriptionActionVM);
    });
