...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.SubscriptionPermissionsCRUDVM();
  });
  ...
  describe('SubscriptionPermissionsCRUDVM', function() {
    it('should create an instance of SubscriptionPermissionsCRUDVM', function() {
      // uncomment below and update the code to test SubscriptionPermissionsCRUDVM
      //var instance = new FastreportCloudSdk.SubscriptionPermissionsCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.SubscriptionPermissionsCRUDVM);
    });
