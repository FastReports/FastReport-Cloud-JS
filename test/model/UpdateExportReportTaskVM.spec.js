...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UpdateExportReportTaskVM();
  });
  ...
  describe('UpdateExportReportTaskVM', function() {
    it('should create an instance of UpdateExportReportTaskVM', function() {
      // uncomment below and update the code to test UpdateExportReportTaskVM
      //var instane = new FastreportCloudSdk.UpdateExportReportTaskVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UpdateExportReportTaskVM);
    });
    ...
    it('should have the property exportParameters (base name: "exportParameters")', function() {
      ...
      //var instance = new FastreportCloudSdk.UpdateExportReportTaskVM();
