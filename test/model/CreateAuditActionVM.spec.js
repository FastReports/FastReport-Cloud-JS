...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.CreateAuditActionVM();
  });
  ...
  describe('CreateAuditActionVM', function() {
    it('should create an instance of CreateAuditActionVM', function() {
      // uncomment below and update the code to test CreateAuditActionVM
      //var instance = new FastreportCloudSdk.CreateAuditActionVM();
      //expect(instance).to.be.a(FastreportCloudSdk.CreateAuditActionVM);
    });
