...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ContactVM();
  });
  ...
  describe('ContactVM', function() {
    it('should create an instance of ContactVM', function() {
      // uncomment below and update the code to test ContactVM
      //var instance = new FastreportCloudSdk.ContactVM();
      //expect(instance).to.be.a(FastreportCloudSdk.ContactVM);
    });
