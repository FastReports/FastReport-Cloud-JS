...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.DataSourcePermissionCRUDVM();
  });
  ...
  describe('DataSourcePermissionCRUDVM', function() {
    it('should create an instance of DataSourcePermissionCRUDVM', function() {
      // uncomment below and update the code to test DataSourcePermissionCRUDVM
      //var instance = new FastreportCloudSdk.DataSourcePermissionCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.DataSourcePermissionCRUDVM);
    });
