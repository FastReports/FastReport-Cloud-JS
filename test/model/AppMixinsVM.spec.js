...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AppMixinsVM();
  });
  ...
  describe('AppMixinsVM', function() {
    it('should create an instance of AppMixinsVM', function() {
      // uncomment below and update the code to test AppMixinsVM
      //var instance = new FastreportCloudSdk.AppMixinsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AppMixinsVM);
    });
