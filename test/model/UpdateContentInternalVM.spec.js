...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UpdateContentInternalVM();
  });
  ...
  describe('UpdateContentInternalVM', function() {
    it('should create an instance of UpdateContentInternalVM', function() {
      // uncomment below and update the code to test UpdateContentInternalVM
      //var instance = new FastreportCloudSdk.UpdateContentInternalVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UpdateContentInternalVM);
    });
