...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.DataSourcePermissionsCRUDVM();
  });
  ...
  describe('DataSourcePermissionsCRUDVM', function() {
    it('should create an instance of DataSourcePermissionsCRUDVM', function() {
      // uncomment below and update the code to test DataSourcePermissionsCRUDVM
      //var instance = new FastreportCloudSdk.DataSourcePermissionsCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.DataSourcePermissionsCRUDVM);
    });
