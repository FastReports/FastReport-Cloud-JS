...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AuditTaskActionVM();
  });
  ...
  describe('AuditTaskActionVM', function() {
    it('should create an instance of AuditTaskActionVM', function() {
      // uncomment below and update the code to test AuditTaskActionVM
      //var instance = new FastreportCloudSdk.AuditTaskActionVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AuditTaskActionVM);
    });
