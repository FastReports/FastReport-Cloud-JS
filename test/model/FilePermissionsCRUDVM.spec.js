...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FilePermissionsCRUDVM();
  });
  ...
  describe('FilePermissionsCRUDVM', function() {
    it('should create an instance of FilePermissionsCRUDVM', function() {
      // uncomment below and update the code to test FilePermissionsCRUDVM
      //var instance = new FastreportCloudSdk.FilePermissionsCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FilePermissionsCRUDVM);
    });
