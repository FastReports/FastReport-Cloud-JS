...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FileCreateFormVM();
  });
  ...
  describe('FileCreateFormVM', function() {
    it('should create an instance of FileCreateFormVM', function() {
      // uncomment below and update the code to test FileCreateFormVM
      //var instance = new FastreportCloudSdk.FileCreateFormVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FileCreateFormVM);
    });
