...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AnalysisResultVM();
  });
  ...
  describe('AnalysisResultVM', function() {
    it('should create an instance of AnalysisResultVM', function() {
      // uncomment below and update the code to test AnalysisResultVM
      //var instance = new FastreportCloudSdk.AnalysisResultVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AnalysisResultVM);
    });
    ...
    it('should have the property newSize (base name: "newSize")', function() {
      // uncomment below and update the code to test the property newSize
      //var instance = new FastreportCloudSdk.AnalysisResultVM();
      //expect(instance).to.be();
    });
