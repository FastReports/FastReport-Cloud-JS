...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ContactGroupsVM();
  });
  ...
  describe('ContactGroupsVM', function() {
    it('should create an instance of ContactGroupsVM', function() {
      // uncomment below and update the code to test ContactGroupsVM
      //var instance = new FastreportCloudSdk.ContactGroupsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.ContactGroupsVM);
    });
