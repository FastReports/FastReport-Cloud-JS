...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.CreateTaskEndVM();
  });
  ...
  describe('CreateTaskEndVM', function() {
    it('should create an instance of CreateTaskEndVM', function() {
      // uncomment below and update the code to test CreateTaskEndVM
      //var instance = new FastreportCloudSdk.CreateTaskEndVM();
      //expect(instance).to.be.a(FastreportCloudSdk.CreateTaskEndVM);
    });
