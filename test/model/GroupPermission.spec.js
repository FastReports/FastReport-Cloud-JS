...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.GroupPermission();
  });
  ...
  describe('GroupPermission', function() {
    it('should create an instance of GroupPermission', function() {
      // uncomment below and update the code to test GroupPermission
      //var instane = new FastreportCloudSdk.GroupPermission();
      //expect(instance).to.be.a(FastreportCloudSdk.GroupPermission);
    });
    ...
    it('should have the property create (base name: "create")', function() {
      ...
      //var instance = new FastreportCloudSdk.GroupPermission();
