...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UsersVM();
  });
  ...
  describe('UsersVM', function() {
    it('should create an instance of UsersVM', function() {
      // uncomment below and update the code to test UsersVM
      //var instane = new FastreportCloudSdk.UsersVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UsersVM);
    });

    it('should have the property users (base name: "users")', function() {
      // uncomment below and update the code to test the property users
      //var instance = new FastreportCloudSdk.UsersVM();
