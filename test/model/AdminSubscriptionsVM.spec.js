...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AdminSubscriptionsVM();
  });
  ...
  describe('AdminSubscriptionsVM', function() {
    it('should create an instance of AdminSubscriptionsVM', function() {
      // uncomment below and update the code to test AdminSubscriptionsVM
      //var instane = new FastreportCloudSdk.AdminSubscriptionsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.AdminSubscriptionsVM);
    });
    ...
    it('should have the property subscriptions (base name: "subscriptions")', function() {
      ...
      //var instance = new FastreportCloudSdk.AdminSubscriptionsVM();
