...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UpdateExportTemplateTaskVM();
  });
  ...
  describe('UpdateExportTemplateTaskVM', function() {
    it('should create an instance of UpdateExportTemplateTaskVM', function() {
      // uncomment below and update the code to test UpdateExportTemplateTaskVM
      //var instane = new FastreportCloudSdk.UpdateExportTemplateTaskVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UpdateExportTemplateTaskVM);
    });
    ...
    it('should have the property reportParameters (base name: "reportParameters")', function() {
      ...
      //var instance = new FastreportCloudSdk.UpdateExportTemplateTaskVM();
