...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission();
  });
  ...
  describe('AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission', function() {
    it('should create an instance of AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission', function() {
      // uncomment below and update the code to test AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission
      //var instance = new FastreportCloudSdk.AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission();
      //expect(instance).to.be.a(FastreportCloudSdk.AdminCreateAdminGetAdminUpdateAdminDeleteAdminExecuteAdminAdministratePermission);
    });
