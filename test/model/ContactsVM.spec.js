...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ContactsVM();
  });
  ...
  describe('ContactsVM', function() {
    it('should create an instance of ContactsVM', function() {
      // uncomment below and update the code to test ContactsVM
      //var instance = new FastreportCloudSdk.ContactsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.ContactsVM);
    });
