...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.GroupPermissionsCRUDVM();
  });
  ...
  describe('GroupPermissionsCRUDVM', function() {
    it('should create an instance of GroupPermissionsCRUDVM', function() {
      // uncomment below and update the code to test GroupPermissionsCRUDVM
      //var instance = new FastreportCloudSdk.GroupPermissionsCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.GroupPermissionsCRUDVM);
    });
