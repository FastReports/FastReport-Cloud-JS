...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.ContactGroupVM();
  });
  ...
  describe('ContactGroupVM', function() {
    it('should create an instance of ContactGroupVM', function() {
      // uncomment below and update the code to test ContactGroupVM
      //var instance = new FastreportCloudSdk.ContactGroupVM();
      //expect(instance).to.be.a(FastreportCloudSdk.ContactGroupVM);
    });
