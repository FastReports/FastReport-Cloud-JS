...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.CreateFetchTaskVM();
  });
  ...
  describe('CreateFetchTaskVM', function() {
    it('should create an instance of CreateFetchTaskVM', function() {
      // uncomment below and update the code to test CreateFetchTaskVM
      //var instane = new FastreportCloudSdk.CreateFetchTaskVM();
      //expect(instance).to.be.a(FastreportCloudSdk.CreateFetchTaskVM);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new FastreportCloudSdk.CreateFetchTaskVM();
