...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.UserResultVM();
  });
  ...
  describe('UserResultVM', function() {
    it('should create an instance of UserResultVM', function() {
      // uncomment below and update the code to test UserResultVM
      //var instance = new FastreportCloudSdk.UserResultVM();
      //expect(instance).to.be.a(FastreportCloudSdk.UserResultVM);
    });
