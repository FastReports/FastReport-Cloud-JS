...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FrontendAppVM();
  });
  ...
  describe('FrontendAppVM', function() {
    it('should create an instance of FrontendAppVM', function() {
      // uncomment below and update the code to test FrontendAppVM
      //var instance = new FastreportCloudSdk.FrontendAppVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FrontendAppVM);
    });
