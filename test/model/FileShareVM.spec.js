...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FileShareVM();
  });
  ...
  describe('FileShareVM', function() {
    it('should create an instance of FileShareVM', function() {
      // uncomment below and update the code to test FileShareVM
      //var instance = new FastreportCloudSdk.FileShareVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FileShareVM);
    });
