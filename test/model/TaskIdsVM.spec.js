...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskIdsVM();
  });
  ...
  describe('TaskIdsVM', function() {
    it('should create an instance of TaskIdsVM', function() {
      // uncomment below and update the code to test TaskIdsVM
      //var instance = new FastreportCloudSdk.TaskIdsVM();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskIdsVM);
    });
