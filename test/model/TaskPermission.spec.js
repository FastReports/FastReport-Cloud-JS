...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskPermission();
  });
  ...
  describe('TaskPermission', function() {
    it('should create an instance of TaskPermission', function() {
      // uncomment below and update the code to test TaskPermission
      //var instane = new FastreportCloudSdk.TaskPermission();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskPermission);
    });
    ...
    it('should have the property create (base name: "create")', function() {
      ...
      //var instance = new FastreportCloudSdk.TaskPermission();
