...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.CreateFileShareVM();
  });
  ...
  describe('CreateFileShareVM', function() {
    it('should create an instance of CreateFileShareVM', function() {
      // uncomment below and update the code to test CreateFileShareVM
      //var instance = new FastreportCloudSdk.CreateFileShareVM();
      //expect(instance).to.be.a(FastreportCloudSdk.CreateFileShareVM);
    });
