...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskPermissionsCRUDVM();
  });
  ...
  describe('TaskPermissionsCRUDVM', function() {
    it('should create an instance of TaskPermissionsCRUDVM', function() {
      // uncomment below and update the code to test TaskPermissionsCRUDVM
      //var instance = new FastreportCloudSdk.TaskPermissionsCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskPermissionsCRUDVM);
    });
