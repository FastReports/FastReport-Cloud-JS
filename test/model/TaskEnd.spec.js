...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskEnd();
  });
  ...
  describe('TaskEnd', function() {
    it('should create an instance of TaskEnd', function() {
      // uncomment below and update the code to test TaskEnd
      //var instance = new FastreportCloudSdk.TaskEnd();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskEnd);
    });
