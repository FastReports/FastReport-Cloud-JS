...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FilePermissionCRUDVM();
  });
  ...
  describe('FilePermissionCRUDVM', function() {
    it('should create an instance of FilePermissionCRUDVM', function() {
      // uncomment below and update the code to test FilePermissionCRUDVM
      //var instance = new FastreportCloudSdk.FilePermissionCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FilePermissionCRUDVM);
    });
