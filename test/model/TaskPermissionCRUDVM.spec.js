...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskPermissionCRUDVM();
  });
  ...
  describe('TaskPermissionCRUDVM', function() {
    it('should create an instance of TaskPermissionCRUDVM', function() {
      // uncomment below and update the code to test TaskPermissionCRUDVM
      //var instance = new FastreportCloudSdk.TaskPermissionCRUDVM();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskPermissionCRUDVM);
    });
