...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FileStatusVM();
  });
  ...
  describe('FileStatusVM', function() {
    it('should create an instance of FileStatusVM', function() {
      // uncomment below and update the code to test FileStatusVM
      //var instance = new FastreportCloudSdk.FileStatusVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FileStatusVM);
    });
