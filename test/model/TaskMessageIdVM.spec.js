...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.TaskMessageIdVM();
  });
  ...
  describe('TaskMessageIdVM', function() {
    it('should create an instance of TaskMessageIdVM', function() {
      // uncomment below and update the code to test TaskMessageIdVM
      //var instance = new FastreportCloudSdk.TaskMessageIdVM();
      //expect(instance).to.be.a(FastreportCloudSdk.TaskMessageIdVM);
    });
