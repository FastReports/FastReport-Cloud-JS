...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FileThumbnailUpdateInternalVM();
  });
  ...
  describe('FileThumbnailUpdateInternalVM', function() {
    it('should create an instance of FileThumbnailUpdateInternalVM', function() {
      // uncomment below and update the code to test FileThumbnailUpdateInternalVM
      //var instance = new FastreportCloudSdk.FileThumbnailUpdateInternalVM();
      //expect(instance).to.be.a(FastreportCloudSdk.FileThumbnailUpdateInternalVM);
    });
