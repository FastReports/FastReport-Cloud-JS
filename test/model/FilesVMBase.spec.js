...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastreportCloudSdk.FilesVMBase();
  });
  ...
  describe('FilesVMBase', function() {
    it('should create an instance of FilesVMBase', function() {
      // uncomment below and update the code to test FilesVMBase
      //var instance = new FastreportCloudSdk.FilesVMBase();
      //expect(instance).to.be.a(FastreportCloudSdk.FilesVMBase);
    });
