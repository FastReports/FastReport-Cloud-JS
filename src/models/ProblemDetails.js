 ...
 * @module models/ProblemDetails
 * @version v1
 */
class ProblemDetails {
    /**
     * Constructs a new <code>ProblemDetails</code>.
     * @alias module:models/ProblemDetails
     * @extends Object
     */
    constructor() { 
     ...
     * @param {module:models/ProblemDetails} obj Optional instance to populate.
     * @return {module:models/ProblemDetails} The populated <code>ProblemDetails</code> instance.
     */
