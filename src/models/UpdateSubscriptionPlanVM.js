...
class UpdateSubscriptionPlanVM {
    ...
    constructor(t) { 
        ...
        UpdateSubscriptionPlanVM.initialize(this, t);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubscriptionPlanVM</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubscriptionPlanVM</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSubscriptionPlanVM.RequiredProperties) {
...
UpdateSubscriptionPlanVM.RequiredProperties = ["$t"];
 ...
 */
UpdateSubscriptionPlanVM.prototype['readonlyTimeLimitType'] = undefined;

/**
 * @member {Number} readonlyTimeLimit
 */
UpdateSubscriptionPlanVM.prototype['readonlyTimeLimit'] = undefined;

/**
 * @member {module:models/TaskSettingsVM} tasks
 */
UpdateSubscriptionPlanVM.prototype['tasks'] = undefined;

/**
 * @member {String} $t
 */
UpdateSubscriptionPlanVM.prototype['$t'] = undefined;
