...
```shell
npm install fastreport-cloud-sdk --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your fastreport-cloud-sdk from, and run:
...
If the library is hosted at a git repository, e.g.https://github.com/FastReports/FastReport-Cloud-js
then install it via:

```shell
    npm install FastReports/FastReport-Cloud-js --save
```
...
var defaultClient = FastreportCloudSdk.ApiClient.instance;
...
var api = new FastreportCloudSdk.AdminApiKeysApi()
var userId = "userId_example"; // {String} 
var opts = {
  'model': new FastreportCloudSdk.CreateApiKeyVM() // {CreateApiKeyVM} 
};
api.adminApiKeysCreateApiKey(userId, opts).then(function(data) {
...
*FastreportCloudSdk.SubscriptionGroupsApi* | [**subscriptionGroupsGetGroupList**](docs/SubscriptionGroupsApi.md#subscriptionGroupsGetGroupList) | **GET** /api/manage/v1/Subscriptions/{id}/groups | returns list of groups in the subscription
...
*FastreportCloudSdk.SubscriptionUsersApi* | [**subscriptionUsersGetUserGroups**](docs/SubscriptionUsersApi.md#subscriptionUsersGetUserGroups) | **GET** /api/manage/v1/Subscriptions/{subscriptionId}/user/{userId}/groups | Returns all users of subscription
